...
FlnkSep = 5;                        % Separation between flankers and Vernier
FlnkHeight = 30;                    % Flanker height
RecWidth = 65;
...
switch lower(StimType)
    ...
    case 'cuboids'
        ...
        EndL = vL-FlnkSep-RecWidth;
        EndR = vR+FlnkSep+RecWidth;
        EndT = Mid(1)-MidFlnkHeight;
        EndB = Mid(1)+MidFlnkHeight;
    ...
    case 'scrambled cuboids'                               
        ...
        xCoords = [-6 7 -48 49 -97 98;
            -39 39 -78 78 -63 63]+Mid(2);
        yCoords = [-5 -5 -21 -21 -33 -33;
            -33 -33 12 12 -6 -6]+Mid(1);                
